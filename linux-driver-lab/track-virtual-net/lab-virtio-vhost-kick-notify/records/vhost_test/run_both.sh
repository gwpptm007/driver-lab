...
run_test() {
    ...
    timeout 30 qemu-system-x86_64 \
        ...
        -fsdev local,id=fs0,path=/tmp/rootfs_test,security_model=mapped,readonly \
        -initrd "$ROOTFS" \
...
echo "ALL DONE - check records at /home/wq7/records/vhost_test/"