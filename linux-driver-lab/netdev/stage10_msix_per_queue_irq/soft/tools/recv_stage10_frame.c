...
#define MAGIC "STAGE10"

/* 与 send 保持一致：Ethernet(14) + IPv4(20) + Payload(28) = 62 bytes */
#define STAGE10_IP_PROTO 253       /* 帧携带的 IP 协议号（实验性） */
#define STAGE10_FRAME_TYPE ETH_P_IP  /* 0x0800，让 kernel 做 L3 hash */
