...
case "$PROFILE" in
    ...
    qemu-x86_64)
        ...
        QEMU_BIN=${QEMU_X86_BIN:-/usr/bin/qemu-system-x86_64}
        CROSS_COMPILE=
        KDIR=
        KERNEL_BUILD_DIR=
        KERNEL_IMAGE=
    ...
    qemu-arm64)
        TARGET_ARCH=arm64
        RUN_MODE=qemu-arm64
        QEMU_BIN=${QEMU_ARM64_BIN:-/usr/bin/qemu-system-aarch64}
        CROSS_COMPILE=${CROSS_COMPILE:-aarch64-linux-gnu-}
        KDIR=${ARM64_BUILD_DIR:-/home/wq7/workspace/driver-lab/kernel-src/linux-5.15.10/build/arm64}
        KERNEL_BUILD_DIR=${ARM64_BUILD_DIR:-/home/wq7/workspace/driver-lab/kernel-src/linux-5.15.10/build/arm64}
        KERNEL_IMAGE=${ARM64_IMAGE:-/home/wq7/workspace/driver-lab/kernel-src/linux-5.15.10/output/arm64/Image}
        ROOTFS_IMAGE_RESOLVED=${ROOTFS_IMAGE:-/home/wq7/workspace/driver-lab/linux-driver-lab/netdev/stage06_arm64_migration/output/rootfs.img}
        QEMU_MACHINE=virt
        QEMU_CPU=cortex-a57
        ;;
    *)
