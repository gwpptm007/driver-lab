...
lspci_candidate="$(find "${DAY24_ROOT}" -path '*/pciutils/lspci' -type f 2>/dev/null | head -n1 || true)"
...
export PCIUTILS_SRC_DIR=${DAY24_ROOT}/third_party/pciutils
